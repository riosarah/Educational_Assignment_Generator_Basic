...
namespace programming_trainer.WebApi.Models
{
    ...
    /// </summary>
    public partial class VersionEntityObjectEdit
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static VersionEntityObjectEdit()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VersionEntityObjectEdit"/> class (created by the generator.)
        /// </summary>
        public VersionEntityObjectEdit()
        {
            Constructing();
