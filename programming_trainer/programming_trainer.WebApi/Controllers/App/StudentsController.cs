...
{
    using TModel = programming_trainer.WebApi.Models.App.Student;
    using TEntity = programming_trainer.Logic.Entities.App.Student;
    using TContract = programming_trainer.Common.Contracts.App.IStudent;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    public sealed partial class StudentsController(Contracts.IContextAccessor contextAccessor) : Controllers.GenericEntityController<TModel, TEntity, TContract>(contextAccessor)
    {
        /// <summary>
