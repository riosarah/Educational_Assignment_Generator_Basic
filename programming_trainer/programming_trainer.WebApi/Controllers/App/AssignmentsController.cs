...
{
    using TModel = programming_trainer.WebApi.Models.App.Assignment;
    using TEntity = programming_trainer.Logic.Entities.App.Assignment;
    using TContract = programming_trainer.Common.Contracts.App.IAssignment;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    public sealed partial class AssignmentsController(Contracts.IContextAccessor contextAccessor) : Controllers.GenericEntityController<TModel, TEntity, TContract>(contextAccessor)
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static AssignmentsController()
        {
            ClassConstructing();
            ClassConstructed();
        }
