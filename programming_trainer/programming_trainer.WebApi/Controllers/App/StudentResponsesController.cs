...
{
    using TModel = programming_trainer.WebApi.Models.App.StudentResponse;
    using TEntity = programming_trainer.Logic.Entities.App.StudentResponse;
    using TContract = programming_trainer.Common.Contracts.App.IStudentResponse;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    public sealed partial class StudentResponsesController(Contracts.IContextAccessor contextAccessor) : Controllers.GenericEntityController<TModel, TEntity, TContract>(contextAccessor)
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static StudentResponsesController()
        {
            ClassConstructing();
            ClassConstructed();
        }
