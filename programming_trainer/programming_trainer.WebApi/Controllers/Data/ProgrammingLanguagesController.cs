...
{
    using TModel = programming_trainer.WebApi.Models.Data.ProgrammingLanguage;
    using TEntity = programming_trainer.Logic.Entities.Data.ProgrammingLanguage;
    using TContract = programming_trainer.Common.Contracts.Data.IProgrammingLanguage;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    public sealed partial class ProgrammingLanguagesController(Contracts.IContextAccessor contextAccessor) : Controllers.GenericEntityController<TModel, TEntity, TContract>(contextAccessor)
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static ProgrammingLanguagesController()
        {
            ClassConstructing();
            ClassConstructed();
        }
