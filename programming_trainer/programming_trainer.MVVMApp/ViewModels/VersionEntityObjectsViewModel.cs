...
namespace programming_trainer.MVVMApp.ViewModels
{
    ...
    /// </summary>
    public partial class VersionEntityObjectsViewModel : GenericItemsViewModel<Models.VersionEntityObject>
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static VersionEntityObjectsViewModel()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VersionEntityObjectsViewModel"/> class (created by the generator.)
        /// </summary>
        public VersionEntityObjectsViewModel()
        {
            Constructing();
