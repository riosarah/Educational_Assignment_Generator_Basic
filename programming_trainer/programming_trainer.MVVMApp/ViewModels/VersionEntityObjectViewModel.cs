...
namespace programming_trainer.MVVMApp.ViewModels
{
    ...
    /// </summary>
    public partial class VersionEntityObjectViewModel : GenericItemViewModel<Models.VersionEntityObject>
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static VersionEntityObjectViewModel()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VersionEntityObjectViewModel"/> class (created by the generator.)
        /// </summary>
        public VersionEntityObjectViewModel()
        {
            Constructing();
