...
namespace programming_trainer.MVVMApp.ViewModels.App
{
    ...
    /// </summary>
    public partial class StudentsViewModel : GenericItemsViewModel<Models.App.Student>
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static StudentsViewModel()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StudentsViewModel"/> class (created by the generator.)
        /// </summary>
