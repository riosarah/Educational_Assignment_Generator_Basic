...
namespace programming_trainer.MVVMApp.ViewModels.App
{
    ...
    /// </summary>
    public partial class AssignmentsViewModel : GenericItemsViewModel<Models.App.Assignment>
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static AssignmentsViewModel()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AssignmentsViewModel"/> class (created by the generator.)
        /// </summary>
