...
namespace programming_trainer.MVVMApp.ViewModels.App
{
    ...
    /// </summary>
    public partial class StudentResponsesViewModel : GenericItemsViewModel<Models.App.StudentResponse>
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static StudentResponsesViewModel()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StudentResponsesViewModel"/> class (created by the generator.)
        /// </summary>
        public StudentResponsesViewModel()
        {
            Constructing();
