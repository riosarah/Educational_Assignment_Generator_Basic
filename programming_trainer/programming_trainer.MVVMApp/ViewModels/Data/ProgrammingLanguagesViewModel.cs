...
namespace programming_trainer.MVVMApp.ViewModels.Data
{
    ...
    /// </summary>
    public partial class ProgrammingLanguagesViewModel : GenericItemsViewModel<Models.Data.ProgrammingLanguage>
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static ProgrammingLanguagesViewModel()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgrammingLanguagesViewModel"/> class (created by the generator.)
        /// </summary>
