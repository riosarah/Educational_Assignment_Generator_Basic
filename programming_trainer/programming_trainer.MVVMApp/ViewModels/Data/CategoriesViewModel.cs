...
namespace programming_trainer.MVVMApp.ViewModels.Data
{
    ...
    /// </summary>
    public partial class CategoriesViewModel : GenericItemsViewModel<Models.Data.Category>
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static CategoriesViewModel()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CategoriesViewModel"/> class (created by the generator.)
        /// </summary>
