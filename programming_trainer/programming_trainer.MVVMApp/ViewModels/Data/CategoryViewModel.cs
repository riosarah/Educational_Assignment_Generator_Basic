...
namespace programming_trainer.MVVMApp.ViewModels.Data
{
    ...
    /// </summary>
    public partial class CategoryViewModel : GenericItemViewModel<Models.Data.Category>
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static CategoryViewModel()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CategoryViewModel"/> class (created by the generator.)
        /// </summary>
