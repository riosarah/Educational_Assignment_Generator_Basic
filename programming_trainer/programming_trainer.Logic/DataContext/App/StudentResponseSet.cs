...
{
    using TEntity = Entities.App.StudentResponse;
    using TContract = programming_trainer.Common.Contracts.App.IStudentResponse;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    internal sealed partial class StudentResponseSet : EntitySet<TEntity>, Contracts.App.IStudentResponseSet
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static StudentResponseSet()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StudentResponseSet"/> class (created by the generator.)
        /// </summary>
        public StudentResponseSet(ProjectDbContext context, DbSet<TEntity> dbSet)
         : base(context, dbSet)
        {
            Constructing();
