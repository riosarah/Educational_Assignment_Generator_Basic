...
{
    using TEntity = Entities.App.Assignment;
    using TContract = programming_trainer.Common.Contracts.App.IAssignment;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    internal sealed partial class AssignmentSet : EntitySet<TEntity>, Contracts.App.IAssignmentSet
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AssignmentSet"/> class (created by the generator.)
        /// </summary>
        public AssignmentSet(ProjectDbContext context, DbSet<TEntity> dbSet)
         : base(context, dbSet)
        {
            Constructing();
