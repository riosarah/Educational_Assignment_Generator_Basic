...
{
    using TEntity = Entities.Data.Category;
    using TContract = programming_trainer.Common.Contracts.Data.ICategory;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    internal sealed partial class CategorySet : EntitySet<TEntity>, Contracts.Data.ICategorySet
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CategorySet"/> class (created by the generator.)
        /// </summary>
        public CategorySet(ProjectDbContext context, DbSet<TEntity> dbSet)
         : base(context, dbSet)
        {
            Constructing();
