...
*****************************************************************************************/
namespace programming_trainer.Logic.DataContext.Data
{
    using TEntity = Entities.Data.ProgrammingLanguage;
    using TContract = programming_trainer.Common.Contracts.Data.IProgrammingLanguage;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    internal sealed partial class ProgrammingLanguageSet : EntitySet<TEntity>, Contracts.Data.IProgrammingLanguageSet
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static ProgrammingLanguageSet()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgrammingLanguageSet"/> class (created by the generator.)
        /// </summary>
        public ProgrammingLanguageSet(ProjectDbContext context, DbSet<TEntity> dbSet)
         : base(context, dbSet)
        {
            Constructing();
