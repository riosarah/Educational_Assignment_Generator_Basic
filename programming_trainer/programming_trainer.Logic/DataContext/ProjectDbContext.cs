//@CodeCopy
using programming_trainer.Common.Modules.Exceptions;
...
{
    /// <summary>
    /// Represents the database context for the programming_trainer application.
    /// </summary>
    internal sealed partial class ProjectDbContext : DbContext, IContext
    {
        ...
        /// </summary>
        private static readonly string ConnectionString = "data source=programming_trainer.db";
        #endregion fields
