//@CodeCopy
#if ACCOUNT_ON
using programming_trainer.Logic.Entities.Account;
using programming_trainer.Logic.Modules.Exceptions;
using programming_trainer.Logic.Modules.Security;
using System.Text;

namespace programming_trainer.Logic.Modules.Account
{
    using PasswordRules = CommonModules.Security.PasswordRules;
    using Error = CommonModules.Exceptions.ErrorType;
    using System.Reflection;
    using programming_trainer.Common.Modules.ThreadSafe;
