...
namespace programming_trainer.Common.Contracts.App
{
    ...
    /// </summary>
    public partial interface IStudentResponse : CommonContracts.IIdentifiable
    {
        IdType AssignmentId { get; set; }
        System.String SubmittedAnswer { get; set; }
        System.Int32 Score { get; set; }
        System.String Feedback { get; set; }
        System.DateTime SubmissionDate { get; set; }
        /// <summary>
        /// Copies the properties of another object to this instance.
        /// </summary>
        /// <param name="other">The object to copy the properties from.</param>
        void CopyProperties(IStudentResponse other)
        {
            bool handled = false;
        ...
        partial void BeforeCopyProperties(IStudentResponse other, ref bool handled);
        /// <summary>
        ...
        partial void AfterCopyProperties(IStudentResponse other);
    }
}
