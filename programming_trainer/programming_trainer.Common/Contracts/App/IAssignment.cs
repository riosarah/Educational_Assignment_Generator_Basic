...
namespace programming_trainer.Common.Contracts.App
{
    ...
    /// </summary>
    public partial interface IAssignment : CommonContracts.IIdentifiable
    {
        IdType StudentId { get; set; }
        System.String StudentPrompt { get; set; }
        IdType CategoryId { get; set; }
        ...
        void CopyProperties(IAssignment other)
        {
            bool handled = false;
            ...
            if (handled == false)
            {
                ...
                StudentPrompt = other.StudentPrompt;
        ...
        partial void BeforeCopyProperties(IAssignment other, ref bool handled);
        /// <summary>
        ...
        partial void AfterCopyProperties(IAssignment other);
    }
}
