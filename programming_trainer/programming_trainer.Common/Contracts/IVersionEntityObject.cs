...
namespace programming_trainer.Common.Contracts
{
    ...
    /// </summary>
    public partial interface IVersionEntityObject : CommonContracts.IIdentifiable
    {
        /// <summary>
        /// Copies the properties of another object to this instance.
        /// </summary>
        /// <param name="other">The object to copy the properties from.</param>
        void CopyProperties(IVersionEntityObject other)
        {
            bool handled = false;
        ...
        partial void BeforeCopyProperties(IVersionEntityObject other, ref bool handled);
        /// <summary>
        ...
        partial void AfterCopyProperties(IVersionEntityObject other);
    }
}
