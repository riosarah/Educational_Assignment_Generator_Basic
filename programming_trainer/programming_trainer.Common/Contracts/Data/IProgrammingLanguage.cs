...
namespace programming_trainer.Common.Contracts.Data
{
    ...
    /// </summary>
    public partial interface IProgrammingLanguage : CommonContracts.IIdentifiable
    {
        ...
        void CopyProperties(IProgrammingLanguage other)
        {
            bool handled = false;
        ...
        partial void BeforeCopyProperties(IProgrammingLanguage other, ref bool handled);
        /// <summary>
        ...
        partial void AfterCopyProperties(IProgrammingLanguage other);
    }
}
